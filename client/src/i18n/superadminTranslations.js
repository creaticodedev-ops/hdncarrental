...
const permsShared = {
  keys: {
    ...
    chauffeurs: { en: 'Chauffeurs', fr: 'Chauffeurs', es: 'Conductores' },
    partners: { en: 'Partners', fr: 'Partenaires', es: 'Socios' },
    accounting: { en: 'Accounting', fr: 'Comptabilité', es: 'Contabilidad' },
  ...
  desc: {
    ...
    chauffeurs: {
      en: 'Chauffeur directory and driver profiles',
      fr: 'Annuaire des chauffeurs et profils',
      es: 'Directorio de conductores y perfiles',
    },
    partners: {
      en: 'Samsars and partner companies',
      fr: 'Samsars et sociétés partenaires',
      es: 'Samsars y empresas socias',
    },
    accounting: {
      en: 'Revenues, Samsar payouts, and agency/vehicle expenses',
      fr: 'Revenus, paiements Samsar et charges agence/véhicules',
      es: 'Ingresos, pagos Samsar y gastos de agencia/vehículos',
    },
    reports: {
...
const buildPerms = (lang) => ({
  ...
  groups: {
    ...
    partners: { en: 'Partners', fr: 'Partenaires', es: 'Socios' }[lang],
    accounting: { en: 'Accounting', fr: 'Comptabilité', es: 'Contabilidad' }[lang],
