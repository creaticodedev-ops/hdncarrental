...
completionRouter.post("/owner/share-signed-contract", ...ownerGate, shareSignedContract);
completionRouter.get("/signed-contract/:bookingId", tokenLimit, streamSignedContractPdf);
